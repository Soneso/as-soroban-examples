...
import { AddressObject, fromI128Pieces, fromU32, Signed128BitIntObject, toU32 } from "as-soroban-sdk/lib/value";
import {Map} from "as-soroban-sdk/lib/map";
import { add_amounts, isNeg, lt, sub_amounts, ERR_CODE, S_AUTHORIZED, S_BALANCE } from "./util";

export function read_balance(addr: AddressObject): Signed128BitIntObject {
...
export function write_balance(addr: AddressObject, amount: Signed128BitIntObject): void {
...
export function receive_balance(addr: AddressObject, amount: Signed128BitIntObject): void {
...
export function spend_balance(addr: AddressObject, amount: Signed128BitIntObject): void {
    if (!is_authorized(addr)) {
