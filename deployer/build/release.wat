(module
 ...
 (import "x" "9" (func $~lib/as-soroban-sdk/lib/env/get_current_contract_address (result i64)))
 ...
 (import "x" "7" (func $~lib/as-soroban-sdk/lib/env/fail_with_error (param i64) (result i64)))
