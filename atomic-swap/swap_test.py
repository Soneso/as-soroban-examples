...
submitter_kp = Keypair.from_secret(
    "SDXD5UCF3QVFQCN6KOZL52IUYDQXCD7NQRQ7QBHRPOAHCDTIAJNUQDFF"
)
alice_kp = Keypair.from_secret(
    "SBQWRJZTG35MXJVOPW2U5AFIXBBWBZZ66DHRPG6B6IKSJ7ZMHOBF7CBQ"
)
bob_kp = Keypair.from_secret(
    "SBLGVUNSOCJHHBI6QFVV6LYRBCNKLQRPRHKRMKRAMIWCKKBX4NQYFGNU"
)
atomic_swap_contract_id = (sys.argv[1])
token_a_contract_id = "CA3XOAR3BWZNOGVNUEGB7GZAQFGXMYTKUDKBGNVQS3MIENTMKXV5KJNB"
token_b_contract_id = "CC2A75VCOD5VVVK4QR6BOGXRIX2HEJMGJYFKLKNVO3Z76KG7RO42LT5G"
