...
submitter_kp = Keypair.from_secret(
    "SAPNLYPOHKXDGUTHQE4QJI73J45TMPCYQ7FDGDRSNZS5NHCQWDCAU4JU"
)
alice_kp = Keypair.from_secret(
    "SA36UPXQW4TY5IUDETXUWJASQN3OWAOK4WCU3UYWXIBNDWVHDK6BC4CQ"
)
bob_kp = Keypair.from_secret(
    "SBL2ZQAPW5ZXUBYI32CFYAHI7ZXHDQB5UA44BOYGMOVH7SY7547OZTAP"
)
atomic_swap_contract_id = (sys.argv[1])
token_a_contract_id = "CBWX3UJRVBVT5MJJZWFL7LUPAHIQKD4PH7EGPEBN53YMDFO7YGNBVQDJ"
token_b_contract_id = "CCFKUSZPMEZHRL6KJUGK4YT6PFN6IEWAZKMZHKPCQIJLSOSPHKEIP6A3"
